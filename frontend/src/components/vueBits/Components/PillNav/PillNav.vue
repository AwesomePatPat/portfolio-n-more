...
<template>
  <div class="top-[1em] left-0 md:left-auto z-[1000] absolute w-full md:w-auto">
    <nav
      :class="[
        'w-full md:w-max flex items-center justify-between md:justify-start box-border px-4 md:px-0',
        className,
      ]"
      aria-label="Primary"
      :style="cssVars"
    >
      ...
      >
        <ul
          role="menubar"
          class="flex items-stretch m-0 p-[3px] h-full list-none"
        ...
        >
          ...
          >
            <component
              ...
              class="inline-flex box-border relative justify-center items-center px-0 rounded-full h-full overflow-hidden font-bold text-[16px] no-underline uppercase leading-[0] tracking-[0.2px] whitespace-nowrap cursor-pointer"
              :style="{
            ...
            >
              ...
              <span class="inline-block z-[2] relative leading-[1] label-stack">
                <span
                  class="inline-block z-[2] relative leading-[1] pill-label"
