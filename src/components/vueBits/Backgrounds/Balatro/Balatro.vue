...
const initBalatro = () => {
  ...
  if (!container) {
    console.error('Balatro: Container not found')
    return
  }

  console.log('Balatro: Initializing...', {
  ...
  try {
    ...
    console.log('Balatro: WebGL context created', gl)
    gl.clearColor(0, 0, 0, 1)
    gl.canvas.style.backgroundColor = 'transparent'
  } catch (error) {
    console.error('Balatro: Error creating WebGL renderer:', error)
    return
  }
  ...
  try {
    ...
    console.log('Balatro: Program created successfully')
  } catch (error) {
    console.error('Balatro: Error creating shader program:', error)
    return
  }
  ...
  console.log('Balatro: Canvas appended, animation started')
