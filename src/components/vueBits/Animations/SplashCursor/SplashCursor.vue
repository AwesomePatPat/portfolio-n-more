...
onMounted(() => {
  ...
  function generateColor(): ColorRGB {
    // Mix of gray with blue (#0057F3) and dark gray (#272727) accent colors
    const rand = Math.random()

    if (rand < 0.4) {
      // Blue accent (#0057F3) - 40% chance
      return {
        r: 0.0 * 0.15,
        g: 0.34 * 0.15,
        b: 0.95 * 0.15
      ...
      // Dark gray accent (#272727) - 30% chance
      return {
        r: 0.15 * 0.15,
        g: 0.15 * 0.15,
        b: 0.15 * 0.15
      ...
      // Light gray variations - 30% chance
      const grayValue = 0.1 + Math.random() * 0.15
      return {
        r: grayValue,
        g: grayValue,
        b: grayValue
